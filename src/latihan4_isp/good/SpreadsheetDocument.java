...
public class SpreadsheetDocument implements ReadableDocument, EditableDocument,
        PrintableDocument, CalculableDocument {
    ...
    public void edit(String content) {
        System.out.println("[SpreadsheetDocument] Editing Spreadsheet: " + filename +
    ...
    public void calculate(String formula) {
        System.out.println("[SpreadsheetDocument] Calculating formula: "
                + formula + " = 5500");
    }
}
